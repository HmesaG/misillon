-- =============================================================================
-- MiSillón — Migración 022: CASCADE en reservas al borrar barbería/peluquero/servicio
-- PostgreSQL 15+ / Supabase
-- Aplicar: supabase db push   (o: psql $DATABASE_URL < 022_reservas_cascade.sql)
-- =============================================================================
